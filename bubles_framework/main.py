...
class DebugApplication(FrameworkBase):

    def __init__(self, routes_obj, fronts_obj):
        self.application = FrameworkBase(routes_obj, fronts_obj)
...
class FakeApplication(FrameworkBase):

    def __init__(self, routes, fronts):
        self.application = FrameworkBase(routes, fronts)
